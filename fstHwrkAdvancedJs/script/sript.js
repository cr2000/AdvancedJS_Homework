...
registerBtn.addEventListener('click', function () {
    ...
    if (student.firstName === "" || student.lastName === "" || student.birthYear === "" || student.academy === "" || student.grades === "") {
        alert(`fill all fields pls!`)
    } else if (!dupicateEntry()) {
